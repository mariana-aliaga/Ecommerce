...
function ecommerce_woocommerce_scripts() {
	wp_enqueue_style( 'ecommerce-woocommerce-style', get_template_directory_uri() . '/woocommerce.css', array(), _S_VERSION );
	...
	wp_add_inline_style( 'ecommerce-woocommerce-style', $inline_font );
}
 ...
 */
function ecommerce_woocommerce_active_body_class( $classes ) {
	$classes[] = 'woocommerce-active';

	return $classes;
}
add_filter( 'body_class', 'ecommerce_woocommerce_active_body_class' );
 ...
 *
	<?php
		if ( function_exists( 'ecommerce_woocommerce_header_cart' ) ) {
			ecommerce_woocommerce_header_cart();
		}
	?>
 */
